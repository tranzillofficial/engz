    ...
    <section id="top" className="relative pt-20 md:pt-24 lg:pt-28 pb-12 lg:pb-16 w-full overflow-hidden bg-white">
      ...
      <div className="w-full max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-8 lg:gap-4">
          ...
          {/* Content Column (In RTL: Left side on desktop — 40% width) */}
          <div className="w-full lg:w-[42%] space-y-6 text-right z-10 lg:pr-4">
            <div className="flex items-center justify-start gap-3 w-full">
              ...
              <div className="inline-flex items-center shrink-0">
                <img
                  ...
                  alt="Engz"
                  className="h-16 sm:h-24 w-auto object-contain drop-shadow-2xs"
                />
              </div>
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
              ...
              >
                ...
                <span>اطلب أي حاجة الآن — بدون حساب</span>
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4 text-xs sm:text-sm text-slate-500 font-medium">
              <div className="flex items-center gap-1.5">
                ...
                <span>تطبيق ويب سريع للموبايل</span>
              </div>
              <span className="text-gray-300">•</span>
              <div className="flex items-center gap-1.5 text-emerald-600 font-semibold">
                <span>✓</span>
                <span>توصيل فوري لأي مكان</span>
              </div>
            </div>
          </div>

          {/* Hero Image Column (In RTL: Right side on desktop — 58% to 60% width) */}
          <div className="w-full lg:w-[58%] relative overflow-hidden flex items-center justify-center">
            <div className="relative w-full overflow-hidden">
              ...
              <img
                ...
                alt="Engz Delivery Service"
                className="w-full h-auto object-cover md:object-contain block drop-shadow-sm select-none"
                loading="eager"
              />

              {/* Linear White Fade on the Right Edge (facing the hero text column in RTL) */}
              ...
              {/* Bottom Subtle Fade to blend into next section */}
