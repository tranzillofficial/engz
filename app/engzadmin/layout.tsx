...
/**
 * Binds every page under /engzadmin to the "admin" installable app: its own
 ...
 */
const cfg = PWA_ROLES.admin;

export const metadata: Metadata = {
  title: cfg.name,
  description: cfg.description,
  applicationName: cfg.shortName,
  manifest: manifestPathFor('admin'),
  appleWebApp: {
    capable: true,
    title: cfg.shortName,
...
export default function EngzadminAppLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
